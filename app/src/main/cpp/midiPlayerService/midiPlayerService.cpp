...
Java_com_jpbjq_midilib_midiPlayerService_player_init_1native(JNIEnv *env, jobject thiz, jstring sf,
...
Java_com_jpbjq_midilib_midiPlayerService_player_release_1native(JNIEnv *env, jobject thiz,
                                                                 jlong ptr) {
...
extern "C"
JNIEXPORT void JNICALL
Java_com_jpbjq_midilib_midiPlayerService_player_noteOn_1native(JNIEnv *env, jobject thiz,
...
extern "C"
JNIEXPORT void JNICALL
Java_com_jpbjq_midilib_midiPlayerService_player_noteOff_1native(JNIEnv *env, jobject thiz,
...
extern "C"
JNIEXPORT void JNICALL
Java_com_jpbjq_midilib_midiPlayerService_player_setProgram_1native(JNIEnv *env, jobject thiz,
                                                                    jlong ptr, jint channel,
                                                                    jint program) {
...
extern "C"
JNIEXPORT void JNICALL
Java_com_jpbjq_midilib_midiPlayerService_player_noteOffAll_1native(JNIEnv * env, jobject thiz, jlong ptr , jint channel) {
...
extern "C"
JNIEXPORT void JNICALL
Java_com_jpbjq_midilib_midiPlayerService_player_render_1float_1native(JNIEnv *env, jobject thiz,
...
extern "C"
JNIEXPORT void JNICALL
Java_com_jpbjq_midilib_midiPlayerService_player_render_1short_1native(JNIEnv *env, jobject thiz,
