...
import com.jpbjq.midilib.midiPlayerAIDL;
...
public class midiViewer extends View {
    ...
    private int currentNote = 60; // 默认音符（中央C）
    ...
    public void init(){
        ...
        service.setPackage("com.jpbjq.midi");
        service.setAction("com.jpbjq.midiPlayerService.playerService");
    ...
    public void stopNote() {
        if (remoteService != null) {
            try {
                // 停止当前音符
                remoteService.noteOff(0, currentNote);
            } catch (Exception e) {
                e.printStackTrace();
            }
        }
    ...
    public void playNote(int note) {
        ...
        if (remoteService != null) {
            try {
                ...
                stopAllNotes();
                // 播放新音符
                remoteService.noteOn(0, note, 100);
            } catch (Exception e) {
                e.printStackTrace();
            }
        }
